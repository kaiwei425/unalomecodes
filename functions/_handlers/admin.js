...
function createAdminHandlers(deps){
  requireDeps(deps, ['json', 'jsonHeadersFor', 'jsonHeaders', 'requireAdminWrite', 'forbidIfFulfillmentAdmin', 'requireAdminPermission', 'getAdminSession', 'getAdminRole', 'getAdminPermissionsForEmail', 'hasAdminPermission', 'getAdminPermissions', 'sanitizePermissionsForRole', 'normalizeRole', 'buildAuditActor', 'auditAppend', 'parseRate', 'checkAdminRateLimit', 'buildRateKey', 'updateDashboardStats', 'getUserStore', 'isAdmin', 'checkRateLimit', 'isPhoneConsultOrder', 'normalizeConsultStage', 'buildBookingNotifyEmail', 'getOrderCustomerEmail', 'isRateLimitError', 'isRateLimitResult', 'requireAdminSlotsManage', 'sleepMs', 'pickTrackStore', 'normalizeTrackEvent', 'recordTrackEvent', 'formatTZ', 'taipeiDateKey', 'taipeiDateParts', 'formatTaipeiDate', 'toWeekdayKey', 'toBirthWeekdayKey', 'getMahaTaksa', 'getYamUbakong', 'getThaiDayColor', 'deriveTabooColor', 'zodiacInfoByKey', 'sunSignByDate', 'moonPhaseInfo', 'fnv1aHash', 'buildLuckyNumbers', 'buildUserSignals', 'buildAdviceLine', 'buildStarText', 'pickPersonalTask', 'buildLocalFortuneV2', 'normalizeFortunePayloadV2', 'normalizeSummaryStars', 'normalizeAdviceWithLine', 'sanitizeRitual', 'callOpenAIFortune', 'ensureFortuneIndex', 'recordFortuneStat', 'isTooSimilar', 'FORTUNE_FORMAT_VERSION', 'PHUM_LABEL', 'MANTRA_LIST', 'GUARDIAN_TONE', 'ICHING_NAMES', 'computeServerDiscount', 'maybeSendOrderEmails', 'sendEmailMessage', 'shouldNotifyStatus', 'sendEmailWithRetry', 'buildStatusUpdateEmailPayload', 'getBookingNotifyEmails', 'getConsultStageLabel', 'getRescheduleConfig', 'getPhoneConsultConfig', 'getPhoneConsultPromoInfo', 'resolvePhoneConsultOptionPrices', 'buildSlotKey', 'parseSlotKey', 'parseTimeToMinutes', 'minutesToHHMM', 'resolveSlotStatus', 'resolveSlotEnabled', 'cleanupExpiredHolds', 'getSlotConfig', 'applyScheduledSlotPublish', 'getServiceSlotMode', 'setServiceSlotMode', 'getServiceSlotWindow', 'setServiceSlotWindow', 'getServiceSlotPublishSchedule', 'setServiceSlotPublishSchedule', 'clearServiceSlotPublishSchedule', 'closeExpiredWindowIfNeeded', 'isSlotWindowActive', 'nowMs', 'parsePublishAt', 'publishSlotKeys', 'unpublishSlotKeys', 'getSessionUser', 'getSessionUserRecord', 'loadUserRecord', 'saveUserRecord', 'ensureUserRecord', 'buildRescheduleEmail', 'getRescheduleNotifyEmails', 'buildRescheduleId', 'updateRescheduleIndex', 'parseSlotStartToMs', 'normalizeQuizInput', 'resolveCreatorName', 'hasCreatorTermsAccepted', 'normalizeTWPhoneStrict', 'getClientIp', 'generateServiceOrderId', 'attachSignedProofs', 'statusIsPaid', 'statusIsCanceled', 'releaseOrderResources', 'ensureOrderPaidResources', 'releaseExpiredOrderHolds', 'isFulfillmentOrderTransitionAllowed', 'orderAmount', 'orderItemsSummary', 'csvEscape', 'normalizeOrderSuffix', 'normalizeStatus', 'statusIsPaidOrReady', 'statusIsWaitingVerify', 'isFoodCreator', 'getAdminQnaUnread', 'clearAdminQnaUnread', 'getUserUnreadTotal', 'clearUserUnreadAll', 'clearUserUnreadForOrder', 'getQnaMetaStore', 'getUserUnreadForOrder', 'getUserCouponUnread', 'requireCronOrAdmin', 'getAny', 'readCoupon', 'orderBelongsToUser', 'findOrderByIdForQna', 'sanitizeQnaItem', 'loadOrderQna', 'saveOrderQna', 'incrementAdminQnaUnread', 'incrementUserUnreadForOrder', 'findUserIdByEmail', 'buildOrderItems', 'isOwnerAdmin', 'getBookingNotifyFlag', 'setBookingNotifyFlag', 'orderQnaHandlers', 'orderFlowHandlers', 'paymentHandlers', 'couponHandlers', 'creatorInviteKey', 'normalizeCreatorCode', 'generateCreatorInviteCode', 'jsonWithHeaders', 'recordFoodMapStat', 'recordTempleMapStat', 'readFood', 'saveFood', 'listFoods', 'readFoodsListCache', 'writeFoodsListCache', 'deleteFoodsListCache', 'upsertFoodsListCache', 'resetFoodsListMemoryCache', 'listTemples', 'mergeTempleRecord', 'normalizeTemplePayload', 'readTemple', 'readTemplesListCache', 'resetTemplesListMemoryCache', 'resolveTempleCoords', 'resolveTempleHours', 'saveTemple', 'upsertTemplesListCache', 'writeTemplesListCache', 'deleteTemplesListCache'], 'admin.js');
  const {
    json,
    jsonHeadersFor,
    jsonHeaders,
