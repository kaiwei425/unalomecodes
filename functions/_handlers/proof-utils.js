...
function createProofUtils(deps){
  requireDeps(deps, ['getAny', 'arrayBufferToBase64', 'signSession', 'verifySessionToken', 'makeToken', 'issueWelcomeCoupon'], 'proof-utils.js');
  const {
    getAny,
    arrayBufferToBase64,
    signSession,
  ...
  return {
    ...
    getAvailableMemberDiscount,
    markMemberDiscountUsed,
